...
import AddtoCartButton from '../components/addcart.vue'
    ...
    return {
      ...
      flowers: [
        ...
        },
        {
          ...
          cost: 9.99,
          image:
            'https://bouqs.com/blog/wp-content/uploads/2021/11/carantion-meaning-and-symbolism.jpg',
          blurb:
        ...
        },
        {
          ...
          cost: 13.99,
          image:
            'https://www.southernliving.com/thmb/gYMDrpPeIZ6a4k5UNcbGglOjCKo=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/gettyimages-859455640-1-3958af52944e41d6bea36341c85cf383.jpg',
          blurb:
        ...
        },
        {
          ...
          cost: 11.99,
          image:
            'https://www.almanac.com/sites/default/files/styles/or/public/image_nodes/dahlia-shutterstock.jpg?itok=_d0QgCF0',
          blurb:
        ...
        },
        {
          ...
          cost: 25.0,
          image:
            'https://www.thespruce.com/thmb/DUZvy_YzMK5I_cIQigxjjqwhbIY=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/beautiful-lily-varieties-to-grow-4136203-3-ecb49980016c4a498a90d6c379307ddd.jpg',
          blurb:
        ...
        },
        {
          ...
          cost: 14.99,
          image:
            'https://www.washingtonian.com/wp-content/uploads/2021/07/Liberty-Mills-3-1-2048x1365.jpg',
          blurb:
        ...
        },
        {
          ...
          cost: 10.99,
          image:
            'https://awkwardbotany.files.wordpress.com/2017/05/ranunculus_bulbosus_003.jpg?w=640',
          blurb:
        ...
        },
        {
          ...
          name: 'Hydrangea',
          cost: 12.99,
          image: 'https://m.media-amazon.com/images/I/81svXs+WOuL._AC_UF894,1000_QL80_.jpg',
          blurb:
        ...
        },
        {
          ...
          cost: 7.58,
          image:
            'https://hgtvhome.sndimg.com/content/dam/images/grdn/fullset/2013/4/15/0/CI_ci-shasta-daisy-white-flower-farm.jpg.rend.hgtvcom.406.305.suffix/1452753540053.jpeg',
          blurb:
...
<template>
  <main>
    <div class="cartnav">
      <CartButton class="cartbutton" @click="cartdiv = !cartdiv">Cart</CartButton>
    </div>
    <div v-show="cartdiv" class="cartdiv">
      <div class="cartitemsdiv">
        <h3>Items:</h3>
        <Cart v-for="item in store.cart" :name="item.name" :cost="item.cost" :image="item.image" />
      </div>
    </div>
    <div class="flowers">
      <Card
